...
pub fn get_move(notation: &str, game: &mut game::GameInfo) -> move_gen::Move {
    ...
    let re = Regex::new("([RBQKPN])?([a-h])?([1-8])?([x])?([a-h])?([1-8])?([=]?)([QNRB]?)([+#]?)")
        .unwrap()
        .captures(notation)
        .unwrap();
    ...
    let piece: piece::Piece = match re.get(1) {
        Some(x) => match x.as_str() {
            "R" => {
                if turn == &game::Color::White {
                    piece::Piece::White(piece::PieceType::Rook)
                } else {
                    piece::Piece::Black(piece::PieceType::Rook)
                }
            }
            "B" => {
                if turn == &game::Color::White {
                    piece::Piece::White(piece::PieceType::Bishop)
                } else {
                    piece::Piece::Black(piece::PieceType::Bishop)
                }
            }
            "Q" => {
                if turn == &game::Color::White {
                    piece::Piece::White(piece::PieceType::Queen)
                } else {
                    piece::Piece::Black(piece::PieceType::Queen)
                }
            }
            "K" => {
                if turn == &game::Color::White {
                    piece::Piece::White(piece::PieceType::King)
                } else {
                    piece::Piece::Black(piece::PieceType::King)
                }
            }
            "N" => {
                if turn == &game::Color::White {
                    piece::Piece::White(piece::PieceType::Knight)
                } else {
                    piece::Piece::Black(piece::PieceType::Knight)
                }
            }
            _ => panic!(""),
        },
        None => {
            if turn == &game::Color::White {
                piece::Piece::White(piece::PieceType::Pawn)
            } else {
                piece::Piece::Black(piece::PieceType::Pawn)
            }
        }
    };
    ...
    move_gen::Move {
        origin: origin as i8,
        destiny: destiny as i8,
        destiny_piece: destiny_piece,
        promotion: promotion,
    }
}
